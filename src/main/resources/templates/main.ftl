...
<div class="block">
    ...
    <div class="top-menu-wrapper">
        <div class="top-menu" id="main">
            ...
            <a href="#gallery">
                <div class="galleryMenu">Gallery</div>
            </a>
        </div>
    </div>
    <div class="midlle" id="menu">
        ...
        <div class="viewBlock">
            <div class="sliderViewBlock">
                ...
                <div class="sliderViewBlock-wrapper">
                    <#list products as product>
                        <div class="productBlock">
                        <div class="productImg"><img src="/images/${product.getPage()}" alt="Image" width="100%"
                                                                                        height="100%">
                        </div>
                        <div class="productName">${product.getName()}</div>
                        <div class="productText">${product.getText()}</div>
                        <div class="productQuantity">${product.getQuantity()}</div>
                        <div class="productPrice">${product.getPrice()} грн</div>
                        </div>
                    </#list>
                </div>
            </div>
